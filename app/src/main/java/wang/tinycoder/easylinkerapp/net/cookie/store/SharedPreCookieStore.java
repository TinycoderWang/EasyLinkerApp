package wang.tinycoder.easylinkerapp.net.cookie.store;
...
public class SharedPreCookieStore implements CookieStore {

    private static final String LOG_TAG = "SharedPreCookieStore";
     ...
     * @param context 上下文
     */
    public SharedPreCookieStore(Context context) {
    ...
    protected void add(HttpUrl uri, Cookie cookie) {
        ...
        Log.i(LOG_TAG, " cookiePersistent --- " + cookie.persistent());
        ...
        Log.i(LOG_TAG, " --- " + TextUtils.join(",", cookies.get(uri.host()).keySet()));
