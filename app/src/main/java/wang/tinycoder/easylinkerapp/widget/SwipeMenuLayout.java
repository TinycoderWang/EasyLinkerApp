...
public class SwipeMenuLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mLimit = mRightMenuWidths * 5 / 10;//滑动判断的临界值
        ...
        if (isSwipeEnable) {
            ...
            switch (ev.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    //Logger.i(TAG, "gap = " + gap + " , ev.getRawX() = " + ev.getRawX() + " , mLastP.x = " + mLastP.x);
                    //Logger.e(TAG, "gapY = " + gapY + " , ev.getRawY() = " + ev.getRawY() + " , mLastP.y = " + mLastP.y);
                    //为了在水平滑动中禁止父类ListView等再竖直滑动
                    if (Math.abs(gap) > 10 || Math.abs(getScrollX()) > 10) {//2016 09 29 修改此处，使屏蔽父布局滑动更加灵敏，
                        getParent().requestDisallowInterceptTouchEvent(true);
                        //Logger.i(TAG, "requestDisallowInterceptTouchEvent");
                    }
